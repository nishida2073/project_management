...
if not defined DOWNLOAD_SITE_FOLDER set "DOWNLOAD_SITE_FOLDER=Shared Documents/Fy27標準化Pj/テスト用/ツール/原本"
...
if not defined GENERATE_CONFIG_PATH set "GENERATE_CONFIG_PATH=%DOWNLOAD_LOCAL_DEST%\package_definition.xlsx"
...
if not defined GENERATE_OUTPUT_PATH set "GENERATE_OUTPUT_PATH=%BASE_DIR%generated"
...
if not defined UPLOAD_SITE_FOLDER set "UPLOAD_SITE_FOLDER=Shared Documents/Fy27標準化Pj/テスト用/ツール/納品"
