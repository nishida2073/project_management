...
if not defined DOWNLOAD_SITE_PATH set "DOWNLOAD_SITE_PATH=Shared Documents/Fy27標準化Pj/テスト用/ツール/原本2"
...
if not defined GENERATE_SOURCE_PATH set "GENERATE_SOURCE_PATH=%BASE_PATH%download"
if not defined GENERATE_CONFIG_PATH set "GENERATE_CONFIG_PATH=%BASE_PATH%clients\template\package_definition.xlsx"
...
if not defined GENERATE_CONFIG_LOG_PREFIX set "GENERATE_CONFIG_LOG_PREFIX=定義ファイル作成_"
