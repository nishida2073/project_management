...
import com.ssfrontier.smstokintone.databinding.ActivitySenderInfoBinding
...
class SenderInfoActivity : AppCompatActivity() {
    ...
    /** この画面のViewBinding */
    private lateinit var binding: ActivitySenderInfoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySenderInfoBinding.inflate(layoutInflater)
