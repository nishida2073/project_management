...
- 送信状況：「未」「済（自動）」「済（手動）」それぞれのチェックボックスを初期状態でONにするかどうかを設定します（いずれも既定はOFF）
- 形式：「形式 🆗 正常」「形式 🆖 異常」「形式 ❎ 除外」それぞれのチェックボックスを初期状態でONにするかどうかを設定します（いずれも既定はOFF）
...
<p float="left">
  <img src="screenshots/app_reply_message_standard.png" alt="SMSの返信（返信メッセージ）">
  <img src="screenshots/app_reply_message_failed.png" alt="SMSの返信（返信メッセージ）">
</p>
...
<p float="left">
  <img src="screenshots/app_sms_continuation_range.png" alt="SMSの引き継ぎ（引き継ぎ項目の編集）">
</p>
...
<p float="left">
  <img src="screenshots/app_sms_continuation_name_enable.png" alt="SMSの引き継ぎ（引き継ぎ項目の編集）">
</p>
...
<p float="left">
  <img src="screenshots/app_sms_continuation_edit.png" alt="SMSの引き継ぎ（引き継ぎ項目の編集）">
</p>
...
<p float="left">
  <img src="screenshots/continuation_edit.png" alt="引き継ぎ項目の編集画面">
</p>
...
<p float="left">
  <img src="screenshots/continuation_edit_target.png" alt="項目の編集（会社名・氏名）">
</p>
...
<p float="left">
  <img src="screenshots/continuation_edit_delete.png" alt="個別削除">
</p>
...
<p float="left">
  <img src="screenshots/continuation_edit_deleteall.png" alt="全体削除">
</p>
