...
set "SCRIPT_PATH=%~dp0post-collect-results.ps1"
...
for %%F in ("%ClientDataRootDir%\%TargetGroupNameFilter%*.xlsx") do (
    ...
    if exist "!envFile!" (
        ...
        start "" /b powershell -NoProfile -ExecutionPolicy Bypass -Command ^
          ...
          "     -BaseUrl '!BaseUrl!'" ^
          "     -TargetGroupName '%%~nF'" ^
          "     -TestOutputDir '!OutputTestCollectDir!'" ^
          "     -TestOutputFileSuffix '!OutputTestResultFileSuffix!'" ^
          "     -SurveyOutputDir '!OutputSurveyCollectDir!'" ^
          "     -SurveyOutputFileSuffix '!OutputSurveyResultFileSuffix!'" ^
