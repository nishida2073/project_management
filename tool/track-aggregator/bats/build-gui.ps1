...
$outputFile = Join-Path $basePath "trackデータ集計ツール.exe"

Invoke-PS2EXE -inputFile $inputFile -outputFile $outputFile -STA -noConsole -title "trackデータ集計ツール" -product "trackデータ集計ツール" -version "1.0.0.0"
