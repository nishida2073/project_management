...
$outputFile = Join-Path $basePath "kintoneデータ集計ツール.exe"

Invoke-PS2EXE -inputFile $inputFile -outputFile $outputFile -STA -noConsole -title "kintoneデータ集計ツール" -product "kintoneデータ集計ツール" -version "1.0.0.0"
