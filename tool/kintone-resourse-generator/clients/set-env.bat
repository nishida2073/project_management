...
if not defined COMMON_BASE_TEMPLATE_PATH set "COMMON_BASE_TEMPLATE_PATH=%BASE_PATH%base-template"
if not defined COMMON_CUSTOM_TEMPLATE_PATH set "COMMON_CUSTOM_TEMPLATE_PATH=%BASE_PATH%custom-template"
